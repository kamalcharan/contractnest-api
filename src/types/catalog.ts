...
// ✅ PRODUCTION: Express/GraphQL catalog types - Complete type definitions
...
// Contact classifications for team_staff validation
...
// Multi-currency pricing stored in price_attributes JSONB
...
// Price attributes stored as JSONB in catalog items
export interface PriceAttributes {
  ...
  // Multi-currency support in JSONB
...
export interface CatalogItem {
  ...
  // Resource composition (stored as JSONB)
...
export interface CreateCatalogItemRequest {
  ...
  pricing?: CreateCatalogPricingRequest[];
}
...
// Multi-currency pricing operations (JSONB-based)
...
// Catalog pricing request for transaction support
export interface CreateCatalogPricingRequest {
  price_type: string;
  currency: SupportedCurrency;
  price: number;
  tax_included?: boolean;
...
// Catalog item pricing responses (JSONB-based)
...
// Contact classification validation
...
// Multi-currency validation utilities
...
export function validateMultiCurrencyPricing(data: CreateMultiCurrencyPricingRequest): { 
  isValid: boolean; 
